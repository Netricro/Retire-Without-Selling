...
export default function TheEconomics() {
  return (
    <div className="flex flex-col flex-1">
      ...
      {/* SECTION 3: Why the Multiple Increases */}
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="animate-fade-in-up">
            ...
            <h2 className="text-4xl md:text-5xl mb-12 leading-tight">
              Why the Multiple<br />
              <span className="gradient-text">Increases</span>
            </h2>
            ...
            <div className="glass rounded-2xl p-8 md:p-12 glow-blue border border-[#3A7BFF]/20 relative overflow-hidden">
              ...
              <div className="pl-6 space-y-6 text-lg text-[#94a3b8] leading-relaxed">
                <p className="text-2xl text-white font-light">
                  A business dependent on the owner sells for 1–2x. A business with documented systems, strong management, diversified revenue, and clean financials sells for 8–12x.
                </p>
                <p className="text-white font-semibold">
                  The difference is not magic. It is the work of stabilising, systemising, and scaling.
                </p>
              </div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
              <div className="glass rounded-xl p-8 border border-red-500/20 relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-red-500/40" />
                <h3 className="text-[#94a3b8] font-semibold mb-6 text-lg tracking-wider uppercase">1–2x Multiple Business</h3>
                <ul className="space-y-3 text-[#94a3b8]">
                  ...
                  <li className="flex items-center gap-3">
                    <span className="text-red-400">✗</span>
                    <span>No documented systems</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="text-red-400">✗</span>
                    <span>Concentrated customer base</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="text-red-400">✗</span>
                    <span>Poor financial records</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="text-red-400">✗</span>
                    <span>No management team</span>
                  </li>
                </ul>
              </div>
              <div className="glass rounded-xl p-8 border border-[#3A7BFF]/30 relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-[#3A7BFF]/40" />
                <h3 className="text-[#3A7BFF] font-semibold mb-6 text-lg tracking-wider uppercase">8–12x Multiple Business</h3>
                <ul className="space-y-3 text-[#94a3b8]">
                  <li className="flex items-center gap-3">
                    <span className="text-emerald-400">✓</span>
                    <span>Runs without owner</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="text-emerald-400">✓</span>
                    <span>Fully documented systems</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="text-emerald-400">✓</span>
                    <span>Diversified customers</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="text-emerald-400">✓</span>
                    <span>Clean, audited financials</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="text-emerald-400">✓</span>
