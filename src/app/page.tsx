        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            ...
            <div className="animate-fade-in-up animation-delay-300">
              ...
              <p className="text-[#94a3b8] mt-4 text-lg">UK owners retiring, fewer than 1,000 buyers</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 relative">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-[#94a3b8] mt-6 text-sm">
            Or <Link href="/contact" className="text-[#3A7BFF] hover:underline">book a discovery call</Link>
          </p>
        </div>
      </section>
    </div>
